    ...
    <div className="w-screen min-h-screen h-fit overflow-x-hidden bg-cyan-800 text-white">
      ...
      <div className="mx-auto w-3/4 max-w-4xl">
        ...
        <div className="flex flex-row-reverse">
          <button className=" bg-cyan-700 hover:bg-cyan-900 p-2 border rounded" onClick={handleOpenModal}>Help</button>
        </div>
        <form className="bg-cyan-700 rounded-md p-4 shadow-lg" onSubmit={handleSubmit}>
          <div className="flex my-2 h-6">
            ...
            <input ref={memRef} placeholder="10000" className="my-auto text-black px-2 ml-4 w-full rounded border" onChange={handleMemChange} type="text" id="memory" name="memory"/>
          </div>
          ...
          <div className="flex">
            ...
            <div className="flex w-full justify-evenly">
              <button onClick={setExample1} className="bg-cyan-700 hover:bg-cyan-900 p-2 border rounded" >Factorial</button>
              <button onClick={setExample2} className="bg-cyan-700 hover:bg-cyan-900 p-2 border rounded" >Binary Search Tree</button>
              <button onClick={setExample3} className="bg-cyan-700 hover:bg-cyan-900 p-2 border rounded" >Quicksort</button>
              <button onClick={setExample4} className="bg-cyan-700 hover:bg-cyan-900 p-2 border rounded" >Pathfinding</button>
              <button onClick={setExample5} className="bg-cyan-700 hover:bg-cyan-900 p-2 border rounded" >Garbage Collection</button>
            </div>
          </div>

          <textarea ref={editorRef} className="whitespace-nowrap text-black font-mono my-2 p-2 h-96 w-full rounded border" onChange={handleCodeChange} id="code" name="code" />
